...
<section class="items-center justify-center" style="background-color: #e8ded0;">
  <div class="mx-auto max-w-7xl py-16 px-6 sm:px-10 lg:px-20 items-center justify-center">
    ...
    <div class="h-fit items-center">
      <!-- Flex wrapper -->
      <div class="flex flex-col lg:flex-row gap-12 justify-center sm:items-center">
        <?php foreach ($rooms as $room): ?>
          <div class="flex-1 flex flex-col lg:flex-col bg-white rounded-lg shadow-lg overflow-hidden w-full">
  
            <!-- Image -->
            <div class="h-fit overflow-hidden sm:w-full">
              <img src="<?= $room['image'] ?>" alt="<?= $room['name'] ?>" class="w-full h-full object-cover">
            </div>
  
            <!-- Content -->
            <div class="flex flex-col justify-between h-fit px-6 py-6">
              <div>
                <!-- Icon and type -->
